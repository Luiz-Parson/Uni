...
{
    public partial class FrmAssociationsBySKU : Form
    {
        ...
        public FrmAssociationsBySKU(TcpReader tcpReader)
        {
            InitializeComponent();
        ...
        private async void FrmAssociationsBySKU_LoadAsync(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                foreach (DataGridViewRow row in dataGridViewRegisterProducts.Rows)
                {
                    ...
                    if (!string.IsNullOrEmpty(epc))
                    {
                        ...
                        if (product == null)
                        {
                            product = await AddProduct(selectedDescription, selectedSKU, epc, Program.systemUserLogged.Username);
                        } else
                        {
